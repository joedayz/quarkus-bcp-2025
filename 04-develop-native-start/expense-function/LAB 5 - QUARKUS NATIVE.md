...
Abre el proyecto `04-develop-native-start` en tu IDE preferido. El proyecto contiene:
- `expense-function`: Aplicación Quarkus con funciones para gestionar gastos
...
### 4.1. Configurar container-build

Abre `expense-function/src/main/resources/application.properties` y actualiza la configuración:
...
## 8. Comparar tamaños de imagen (Opcional)
...
## 9. Usar Dockerfile.native-micro (Opcional)
...
- **Tiempo de inicio rápido**: Las aplicaciones nativas inician en milisegundos
- **Menor consumo de memoria**: Usan menos memoria en tiempo de ejecución
- **Imágenes más pequeñas**: Las imágenes de contenedor son más pequeñas
...
- Compara el rendimiento entre aplicaciones JVM y nativas
